...
**[Hello-Microverse]** is a test to see if I understand how to create a professional repository with automated workflow.
...
Clone this repository to your desired folder:
    https://github.com/ahmed025566/hello-microverse.git
### Install
